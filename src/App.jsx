...
const questions = [
  {
    id: "world",
    text: "What kind of world do you want to escape into?",
    type: "choice",
    options: ["Fantasy realm", "Sci-fi future", "Real-world drama", "Historical setting", "Mystery/thriller"]
  },
  {
    id: "feeling",
    text: "What do you want to feel when you close the last page?",
    type: "choice",
    options: ["Comforted", "Thrilled", "Thoughtful", "Inspired", "Satisfied/complete"]
  },
  {
    id: "time",
    text: "How much time can you commit?",
    type: "choice",
    options: ["Quick read (under 300 pages)", "Medium (300-500 pages)", "I'm in it for the long haul"]
  },
  {
    id: "loved",
    text: "Name one book, movie, or show you loved — and why",
    type: "text"
  },
  {
    id: "vibe",
    ...
    type: "choice",
    options: ["Curious", "Cozy", "Adventurous", "Reflective", "Escapist"]
  },
  {
    id: "avoid",
...
const [result, setResult] = useState(null)
  ...
  setLoading(true)
  try {
    const response = await axios.post('http://localhost:5000/api/recommend', finalAnswers)
...
return (
    <div className="min-h-screen bg-[#0e0c0a] text-[#f4ede1] font-serif flex items-center justify-center px-4">
